...
export class PaymentsController {
  ...
  @Post('webhooks/flutterwave') // ← ADD THIS NEW ENDPOINT
  ...
  async handleFlutterwaveWebhook(
    ...
    try {
      ...
      if (!signature) {
        throw new HttpException('Missing Flutterwave signature', HttpStatus.BAD_REQUEST);
      }

      // Determine event type from Flutterwave webhook
      ...
      this.logger.error(`Flutterwave webhook failed: ${error.message}`, error.stack);
